...
function App() {
  ...
  const handleNavClick = (section, filter = null) => {
    if (filter) {
    ...
    <>
      ...
      >
        ...
        <div id="main-wrapper">
          ...
          <ClassicHeader handleNavClick={handleNavClick} activeFilter={activeFilter} setActiveFilter={setActiveFilter}></ClassicHeader>
